...
<<mmcomp4, fig.align="center", fig.width=12, fig.height=8>>=
gamma <- c(0, 0.25, 0.5)
B <- 1000
N <- 100

mmcomp4 <- simulate_tests_which_residuals(gamma, B, N)
plot_power_curves_which_residuals(mmcomp4)+
...
<<mmcomp5, fig.align="center", fig.width=12, fig.height=8>>=
gamma <- c(0, 0.25, 0.5)
B <- 1000
N <- 100

mmcomp5 <- simulate_tests_which_residuals(gamma, B, N, selection = "correlated", nu = 1)
plot_power_curves_which_residuals(mmcomp5)+
  ggtitle("Power Curves for Varying Magnitude of Treatment Effects\n Treatment Assignment with Cov(T, X1) = 1") + geom_abline(intercept=0, slope=1, linetype = "dashed")
@



<<mmcomp6, fig.align="center", fig.width=12, fig.height=8>>=
gamma <- c(0, 0.25, 0.5)
B <- 1000
N <- 100

mmcomp6 <- simulate_tests_which_residuals(gamma, B, N, selection = "correlated", nu = 5)
plot_power_curves_which_residuals(mmcomp6)+
  ggtitle("Power Curves for Varying Magnitude of Treatment Effects\n Treatment Assignment with Cov(T, X1) = 5") + geom_abline(intercept=0, slope=1, linetype = "dashed")
@
...
<<compare_tests5, fig.align="center", fig.width=8, fig.height=5>>=
